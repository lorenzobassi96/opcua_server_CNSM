        ...
        while 15 == 15:
         for k in range(0, dim_obj_list):   
          ...
          for p in range(0, num_variables):
             ...
             temp1 = random.randint(1,10000) 

             
             #print ("dim_obj_list : ",dim_obj_list)
             #print ("dim_var_list : ",num_variables)

             server.set_attribute_value(globals()[f"myvar_{k}_{p}"].nodeid, ua.DataValue(temp1))
             print(" ")
             #print("var k = ",k)
             #print("var p = ",p)
             print("New value myvar_",k,"_",p,":", temp1 )
             print("------------------------------------------------")
             time.sleep(sleep)
